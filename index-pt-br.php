<?php
    ob_start();
?>
        <h1 id='gentle'>Uma Suave Introdução à Análise de Complexidade de Algoritmos</h1>
        Dionysis "dionyziz" Zindros &lt;<a href='mailto:dionyziz@gmail.com'>dionyziz@gmail.com</a>&gt;<br />
        Bernardo Figuerêdo Domingues &lt;<a href="mailto:bernardofd@gmail.com">bernardofd@gmail.com</a>

        <?= $translations ?>

        <h2 id='intro'>Introdução</h2>
        <p>Muitos dos programadores que criam os softwares mais incríveis e úteis, os quais vemos hoje por aí na Internet ou usamos diariamente, não têm um embasamento teórico em Ciência da Computação. Ainda assim, eles são programadores talentosos e criativos, e temos que agradecê-los pelo que contruíram.</p>

        <p>Entretanto, a teoria da Ciência da Computação tem seus usos e aplicações práticas que podem se tornar muito úteis no dia a dia. Neste artigo voltado aos desenvolvedores que conhecem sua arte mas não tem uma base teórica em Ciência da Computação, eu apresentarei uma das ferramentas mais pragmáticas da disciplina: a notação <b>Grande-O</b> e a análise de complexidade de algoritmos. Sendo alguém que trabalhou tanto em um ambiente acadêmico em Ciência da Computação quanto em um ambiente industrial de desenvolvimento de software ao nível de produção, esta é a ferramenta que eu considero ser uma das mais úteis na prática, a qual eu espero, após ler este artigo, que você aplique em seu próprio código para torná-lo melhor. Ao acabar de ler este texto, você deverá ser capaz de compreender todos os termos normalmente usados pelos cientistas da computação, como o "Grande O", "comportamento assintótico" e "análise do pior caso".</p>
